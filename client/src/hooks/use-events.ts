import { EVENTS_QUERY, type EventFilterInput } from '@/graphql/queries';
...
export const useEvents = () => {
  ...
  useEffect(() => {
    if (data) {
      setPagination((prev) => ({ ...prev, total: data.events.pagination.total, pages: data.events.pagination.pages }));
    }
  }, [data]);
